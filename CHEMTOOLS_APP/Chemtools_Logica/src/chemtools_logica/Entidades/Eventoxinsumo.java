...
public class Eventoxinsumo implements Serializable {
    ...
    @Id
    @Column(name = "idEventoxinsumo", nullable = false)
    private int idEventoxinsumo;
    ...
    public void setIdEventoxinsumo(int idEventoxinsumo) {
        this.idEventoxinsumo = idEventoxinsumo;
    }

    public int getIdEventoxinsumo() {
        return idEventoxinsumo;
    }
}
